...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        // print path to our user defaults file
    ...
    */
        let container = NSPersistentContainer(name: "DataModel") // this has to match our data model name
        container.loadPersistentStores(completionHandler: {(storeDescription, error) in
            ...
            Typical reasons for an error here include:
                 ...
                 - The persistent store is not accessible, due to permissions or data protection when the device is out of locked.
